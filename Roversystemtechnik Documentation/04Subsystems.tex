...
\begin{figure}[h]
	\centering
	\subfloat[Closed]{\includegraphics[height=0.17\textwidth]{Media/tsc_switch_01.png}\label{fig:tsc_switch11}}\qquad\qquad
	\subfloat[Open]{\includegraphics[height=0.17\textwidth]{Media/tsc_switch_02.png}\label{fig:tsc_switch12}}
	\caption{Heat switch.}
...
For that, a thermal network with ten nodes was derived from the rover, shown in \autoref{fig:tsc_network}.
