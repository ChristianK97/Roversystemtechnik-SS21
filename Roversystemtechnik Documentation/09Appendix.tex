...
View Factor 1, Inclination: \quad $ \varphi_1=\cos (\lambda) \cdot \cos (\delta)  $ \\
View Factor 2, Declination: \quad $ \varphi_2=\cos (90^{\circ}-\lambda) \cdot \cos (\delta)  $
...
%TODO welche Tools verwendet (Mulassis) und welchen Orbit zum simulieren
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=1\textwidth]{Media/J_Improvements_Individual}
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=1\textwidth]{Media/J_Improvements_Ice}
	\caption{TID with 4 mm Al shielding and 1 cm of Ice}
	\label{fig:tcs_switch03}
\end{figure}
