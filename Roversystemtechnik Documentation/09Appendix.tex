...
\begin{table}[H]
	...
	\begin{tabular}{l@{\qquad}cccc}
		...
		& & & & \\[-0.75em]
		Insulation & $A_I=3'770 mm^2$ & $t_I=12mm$ & Aerogel & 1 \\[0.5em]
		Bolts, M6 & $A_B=28.3 mm^2$ & $t_B=12mm$ & Titan & 10 \\[4em]
		...
		Part &  Cross section & Thickness  & Material & Amount \\ \hline
		& & & & \\[-0.75em]
		Insulation & $A_I=27'120 mm^2$ & $t_I=12mm$ & Aerogel & 1 \\[0.5em]
		Bolts, M6 & $A_B=28.3 mm^2$ & $t_B=12mm$ & Titan & 10 \\[3em]		
	\end{tabular}
\label{tab:tcs_nodes}
\end{table}	
...
\begin{table}[H]
	...
	\begin{tabular}{l@{\qquad}cccc}
		...
		Boom 3 & $A_{B3}= 97 mm^2$ & $t_{B3}= 60mm$ & Aluminium & 1 \\[0.5em]
		Fork & $A_{F}= 200mm^2$ & $t_{F}=170mm$ & Aluminium & 1 \\[4em]
		...
		Part &  Cross section & Thickness  & Material & Amount \\ \hline
		& & & & \\[-0.75em]
		Suspension & $A_S=137 mm^2$ & $t_S=201mm$ & Aluminium & 1 \\[3em]		
	\end{tabular}
\end{table}	
...
\begin{table}[H]
	...
	\begin{tabular}{l@{\qquad}cccc}
		...
		& & & & \\[-0.75em]
		 ...
		 Bolts & $A_{B}= 3.14 mm^2$ & $t_{B}= 18mm$ & Steel & 4 \\[4em]
		\hline
	Name &  Linked Components &  \multicolumn{3}{c}{Geometry}\\ \hline
	& & & & \\[-0.5em]
...
\begin{table}[H]
	...
	\begin{tabular}{l@{\qquad}cccc}
		...
		Part &  Cross section & Thickness  & Material & Amount \\ \hline
		& & & & \\[-0.75em]
		Rim & $A_R=12 mm^2$ & $t_r=100mm$ & Titan & 6 \\[1.5em]
...
The Europa ground temperature varies at the  equator between $T_{e,min}=80K$ and\\ $T_{e,max}=130 K$, depending on the sun inclination.
