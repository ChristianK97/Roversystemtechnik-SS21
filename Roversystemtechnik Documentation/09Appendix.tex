...
Link budget considerations have been performed under the conservative assumptions listed in table 


\begin{table}[]
\begin{tabular}{llllll}
\hline
Parameter              & Var          & Vlaue & Unit       & source &  \\ \hline
Rover Antenna Gain     & \{G\}\_\{r\} &       & {[}dB{]}   &        &  \\
Rover Output Power     & \{P\}\_\{r\} &       & {[}W{]}    &        &  \\
Rover Line Loss        &              &       & {[}dB{]}   &        &  \\
                       &              &       &            &        &  \\ \hline
R2L polarization loss  &              &       & {[}dB{]}   &        &  \\ 
Path loss              &              &       & {[}dB{]}   &        &  \\
Atmospheric loss       &              &       & {[}dB{]}   &        &  \\ \hline
                       &              &       &            &        &  \\
Lander Antenna Gain    & \{G\}\_\{L\} &       & {[}dB{]}   &        &  \\
Lander Pointing Loss   &              &       & {[}dB{]}   &        &  \\
Lander Line Loss       &              &       & {[}dB{]}   &        &  \\
eff. noise temperature &              &       & {[}K{]}    &        &  \\
                       &              &       &            &        &  \\
data rate              &              &       & {[}kbps{]} &        &  \\
FEC coding             &              &       & {[}-{]}    &        &  \\
technical degradation  &              &       & {[}dB{]}   &        &  \\ 
