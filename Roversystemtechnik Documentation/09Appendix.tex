...
The analysis of the mission data concept for memory capacity and transmission times is derived from the payload camera and Hazcams as images require far more data than telemetry or other payload data.  
