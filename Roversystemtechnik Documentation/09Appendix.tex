...
\toprule
Subsystem                                & Component Name                      & Mass per Component / kg & Quantity & Component Margin & Total / kg \\
\midrule
...
\midrule
\multicolumn{5}{c}{Mass with component margins and 2mm Aluminum Chassis}                                                                    & 27,28          \\
\multicolumn{5}{c}{Mass with component margins and 1,5mm Aluminum Chassis}                                                                  & 26,64          \\
\midrule
\multicolumn{5}{c}{System Margin}                                                                                                          & 10~\%           \\
\midrule
\multicolumn{5}{c}{Total Mass (2mm Aluminum Chassi)}                                                                                       & 30,0           \\
\multicolumn{5}{c}{Total Mass (1,5mm Aluminum Chassi)}                                                                                     & 29,31          \\
\bottomrule
\end{tabular}%
}
\end{table}
...
\begin{table}[htb]
	...
	\begin{tabular}{lccccc}
		...
		RTG  & 414 & 390 & 401 & 407  &  400   \\
		Electric Bay & 297 & 264 & 289 & 309 & 277 \\
		Drill  & 284 & 256 & 267 & 272 & 329  \\
		Camera & 327 & 249 & 256 & 258 & 256 \\
		Chassis & 269 & 231  & 245 & 252 & 247 \\
		Steer Engine & 296 & 249 & 261 & 262 & 261  \\
...
\begin{table}[htb]
	...
	\begin{tabular}{lccccc}
		...
		RTG  & 429 & 375 & 416 & 422  & 415    \\
		Electric Bay & 312 & 249 & 304 & 324 & 292 \\
		Drill  & 299 & 241 & 282 & 287 & 344  \\
		Camera & 342 & 234 & 271 & 273 & 271 \\
		Chassis & 284 & 216 & 260 & 267 & 262 \\
		Steering Engine & 311 & 234 & 276 & 277 & 276  \\
...
\begin{equation}
	\begin{aligned}
		0=\ &  \dot{Q}_{Bay}+ CON_1 \cdot (T_{RTG}-T_{Bay})+ (CON_3+n_{S2}\cdot CON_{S2}) \cdot (T_{Ch}-T_{Bay})-\\[1em]
...
0=\  &   \dot{Q}_{Radar}+\dot{Q}_{Hazcam} +\dot{Q}_{Analyser} +\dot{Q}_{IMUs} +\\[1em]
	& +CON_2 \cdot (T_{RTG}-T_{Ch})+(CON_3+n_{S2}\cdot CON_{S2})\cdot (T_{Bay}-T_{Ch})+ \\[1em]
...
& +\epsilon_{Bay}\cdot \sigma_b \cdot S_{Bay}\cdot T_{Bay}^4 - \frac{1}{2} \cdot \epsilon_{Bo}\cdot \sigma_b \cdot S_{Bo}\cdot \left( \frac{T_{Ch}}{2} +\frac{T_{Node_1}}{2}  \right)^4  -\epsilon_{Ch}\cdot \sigma_b \cdot S_{Ch}\cdot T_{Ch}^4 \\[2em]
\end{aligned}
\end{equation}
...
&  - \frac{1}{2} \cdot \epsilon_{Bo}\cdot \sigma_b \cdot S_{Bo}\cdot \left( \frac{T_{Ch}}{2} +\frac{T_{Node_1}}{2}  \right)^4  - \\[1em]
