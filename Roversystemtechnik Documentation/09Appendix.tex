...
Rover                            &        &            &               &                              &  \\ \hline\hline
Rover Antenna Gain               & 2      & {[}dB{]}   & \{G\}\_\{r\}  & omnidirectional LGA          &  \\
Rover Output Power               & 1      & {[}W{]}    & \{P\}         &                              &  \\
Rover Line Loss                  & 0,6    & {[}dB{]}   & \{L\}\_\{l1\} & FLP                          &  \\ \hline
Path                             &        &            &               &                              &  \\ \hline\hline
R2L polarization loss            & 0,3    & {[}dB{]}   & \{L\}\_\{p\}  & FLP                          &  \\
Free space loss                  & 117,55 & {[}dB{]}   & \{L\}\_\{s\}  &                              &  \\
Atmospheric loss                 & 0      & {[}dB{]}   & \{L\}\_\{a\}  & negligible atmosphere        &  \\ \hline
Lander                           &        &            &               &                              &  \\ \hline\hline
Lander Antenna Gain              & 1      & {[}dB{]}   & \{G\}\_\{L\}  & conservative estimation      &  \\
Lander Pointing Loss             & 0      & {[}dB{]}   &               & omnidirectional LGA          &  \\
Lander Line Loss                 & 0,6    & {[}dB{]}   & \{L\}\_\{l2\} & FLP                          &  \\
