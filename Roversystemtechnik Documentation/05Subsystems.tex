...
\multirow{5}{*}{Structure and Mechanism} & Harness                             & 3                           & 1        & 20\%             & 3,60           \\
                                         & Chassi                              & look up at Chassi Table     & 1        & 20\%             & 5,01           \\
...
With the configured rover, the resulting wheel formula is 4 x 4 x 4. Furthermore, the normal force on Europa can be calculated to \( W \:  = \:	m_\text{total} \cdot g_\text{Europa} \:  = \: 39.45 ~ \text{N} \). Since each wheel is individually driven and controllable, the parameters in the following are designed for one wheel; the normal force per wheel is correspondingly \(W_\text{wheel} = 9.8625 ~ \text{N}\).
