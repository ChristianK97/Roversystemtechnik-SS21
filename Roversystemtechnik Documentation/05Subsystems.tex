...
\begin{itemize}
	...
	\item A variation of $\pm 20\%$ for the emissivity and absorptivity values was considered, if applicable (see \autoref{tab:tcs_surface}). The dissipation power of the LED ist 1.2 Watt.
