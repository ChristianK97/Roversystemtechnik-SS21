...
As part of the design process, it was necessary to perform a static analysis of the chassis. The following load cases were considered: - Stowed state in the TRIPLE lander on Europe - Exploratory configuration on the surface of Europe
...
\multicolumn{5}{c}{Total Mass (1,5mm Aluminum Chassi)}                                                                                     & 29,31          \\ \bottomrule
\end{tabular}%
}
\end{table}
