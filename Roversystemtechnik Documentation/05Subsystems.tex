...
For the insulation, the material \textit{aerogel} will be applied, which has a very low heat conductivity ($ 0.016 - 0.03 \frac{W}{mK} $) as well as a low density ($5 - 200 \frac{kg}{m^3}$) and has also been used in space applications \cite{ref_tcs_03}.
