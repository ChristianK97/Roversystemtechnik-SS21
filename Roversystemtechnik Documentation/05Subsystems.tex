...
Since radiation hardness was not included in most dataheets a total dose of $<20 krad$ was assumed in accordance with values for LEO [Missing Reference]. Please refer to the trade off [Missing Reference].
