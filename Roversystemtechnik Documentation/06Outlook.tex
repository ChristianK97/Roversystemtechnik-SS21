...
\begin{figure}[htb]
     ...
     \caption{The INSPIRE Rover Systen in it's Storage Configuration}
     \label{fig:HighResStore}
\end{figure}

\begin{figure}[htb]
     \centering
     \includegraphics[width=\textwidth]{Media/INSPIRE Mk6_HighRes_Exploration}
     \caption{The INSPIRE Rover Systen in it's Exploration Configuration}
     \label{fig:HighResExplo}
\end{figure}