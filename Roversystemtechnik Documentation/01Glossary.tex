...
${L}_{l}$ 				& 	Line Loss									& dB							\\
${L}_{p}$ 				&	Polarisation Loss							& dB							\\
${L}_{a}$ 				&	Atmospheric Loss								& dB							\\
${L}_{i1}$ 				&	Degradation and Implementation Loss			& dB							\\
...
${P}_{R}$				&	Transmitter Output Power Rover 				& W								\\
$\dot{Q}$				&	Heat flow									& W								\\
...
${T}_{s}$ 				&	Effective Noise Tmeperature					& K								\\
