...
The data output is based on a [missing ref] h European day (tal) and consist of two Locomotion phases which each consists of 70 individually planned legs. A leg takes 310 s. 
